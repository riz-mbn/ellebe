            ...
            <div class="grid-x grid-margin-x">
                <div class="cell large-6 align-self-middle small-order-2 large-order-1">
                    ...
                    <div class="buttons cta-group">
                        <a href="https://ellebe.myaestheticrecord.com/book/appointments" target="_blank" class="button primary icon_button"><?php echo esc_html('Schedule Services'); ?> </a>
                    </div>
                </div>
    ...
    <div class="grid-container">
        <div class="grid-x grid-margin-x cols2-s4">
            <div class="cell large-12">
                ...
                <div class="section_content">
                    <div class="client_logos text_columns">
                        <div class="text_cols5 client_logo">
                            <figure><img src="<?php echo MBN_ASSETS_URI ?>/img/logo_apollomed.png" alt=""></figure>
                        </div>
                        <div class="text_cols5 client_logo">
                        ...
                        <div class="text_cols5 client_logo">
                            <figure><img src="<?php echo MBN_ASSETS_URI ?>/img/logo_allergan.png" alt=""></figure>
                        </div>
                        <div class="text_cols5 client_logo">
                            <figure><img src="<?php echo MBN_ASSETS_URI ?>/img/logo_MIAA.png" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
